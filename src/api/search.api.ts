...
class SearchAPI {
  ...
  async searchSpotify(query: string | null) {
    const response = await fetch(`${process.env.NEXT_PUBILC_SITE_BASE_URL}/api/search/spotify/${query}`);
  ...
  async searchSpotifyArtists(query: string | null, pageParam: number) {
    const response = await fetch(
      `${process.env.NEXT_PUBILC_SITE_BASE_URL}/api/search/spotify/artists/${query}?page=${pageParam}`
    );
  ...
  async searchSpotifyAlbums(query: string | null, pageParam: number) {
    const response = await fetch(
      `${process.env.NEXT_PUBILC_SITE_BASE_URL}/api/search/spotify/albums/${query}?page=${pageParam}`
    );
  ...
  async searchUsers(query: string | null) {
    const response = await fetch(`${process.env.NEXT_PUBILC_SITE_BASE_URL}/api/search/user/${query}`);
